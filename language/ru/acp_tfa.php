...
$lang = array_merge(
	$lang, array(
		...
		'TFA_NOT_REQUIRED'				=> 'Двухфакторная аутентификация включена, но не обязательна',
		'TFA_REQUIRED_FOR_ACP_LOGIN'	=> 'Требуется только для доступа к ACP-панели',
		...
		'TFA_ACP_EXPLAIN'   => 'Есть поставить "не обязательна", администраторам не потребуется использоать двухфакторную аутентификацию для логина в ACP-панель.
		Возможно, вы не захотите так ослаблять защиту ACP.'
	)
);
